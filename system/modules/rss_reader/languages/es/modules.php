...
$GLOBALS['TL_LANG']['MOD']['rss_reader'] = array('Lector RSS', 'Este módulo permite importar datos de RSS feeds.');
$GLOBALS['TL_LANG']['FMD']['rss_reader'] = array('Lector RSS', 'Este módulo permite importar datos de RSS feeds.');
