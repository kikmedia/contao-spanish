...
$GLOBALS['TL_LANG']['tl_user']['calendars'] = array('Calendarios permitidos', 'Permitir acceso a uno o más calendarios.');
$GLOBALS['TL_LANG']['tl_user']['calendarp'] = array('Permisos de calendario', 'Permite definir los permisos para el calendario.');
$GLOBALS['TL_LANG']['tl_user']['calendars_legend'] = 'Permisos del calendario';
