...
$GLOBALS['TL_LANG']['tl_user']['news'] = array('Archivos de noticias', 'Por favor selecciona los archivos de noticias que quieres habilitar para el usuario.');
$GLOBALS['TL_LANG']['tl_user']['newp'] = array('Permisos de noticias', 'Permite definir los permisos para las noticias.');
