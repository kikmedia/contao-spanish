...
$GLOBALS['TL_LANG']['tl_user']['newsletters'] = array('Canales permitidos', 'Permite conceder acceso a uno o más canales.');
$GLOBALS['TL_LANG']['tl_user']['newsletterp'] = array('Permisos de canal', 'Permite definir los permisos para el canal.');
$GLOBALS['TL_LANG']['tl_user']['newsletter_legend'] = 'Permisos de boletín';
