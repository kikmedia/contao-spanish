...
$GLOBALS['TL_LANG']['tl_settings']['repository_wsdl'] = array('URL del repositorio de extensiones', 'Aqui puedes ingresar una URL de algún repositorio de extensiones (archivo WSDL).');
$GLOBALS['TL_LANG']['tl_settings']['repository_legend'] = 'Repositorio de extensiones';
