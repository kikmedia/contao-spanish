...
$GLOBALS['TL_LANG']['MOD']['listing'] = array('Listado', 'Este módulo permite mostrar una lista de los registros de una tabla en el front end.');
$GLOBALS['TL_LANG']['FMD']['listing'] = array('Listado', 'Utiliza este módulo para mostrar una lista de los registros de una tabla en el front end.');
