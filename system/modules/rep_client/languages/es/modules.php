...
$GLOBALS['TL_LANG']['MOD']['rep_client'] = 'Repositorio cliente';
$GLOBALS['TL_LANG']['MOD']['repository_catalog'] = array('Catálogo de extensiones', 'Explorar el repositorio e instalar extensiones.');
$GLOBALS['TL_LANG']['MOD']['repository_manager'] = array('Administrador de extensiones', 'Administrar o remover extensiones instaladas.');
